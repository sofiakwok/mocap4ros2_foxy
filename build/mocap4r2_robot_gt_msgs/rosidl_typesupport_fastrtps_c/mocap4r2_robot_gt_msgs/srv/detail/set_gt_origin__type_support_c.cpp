...
static size_t _SetGTOrigin_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request(
    full_bounded, 0);
}
...
static size_t _SetGTOrigin_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response(
    full_bounded, 0);
}
