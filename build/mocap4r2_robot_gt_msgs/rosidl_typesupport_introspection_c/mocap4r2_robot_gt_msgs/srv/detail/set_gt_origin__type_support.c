...
void SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_init_function(
...
void SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_fini_function(void * message_memory)
{
  mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_member_array[2] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_members = {
  ...
  SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_member_array,  // message members
  SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_type_support_handle = {
  0,
  &SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap4r2_robot_gt_msgs, srv, SetGTOrigin_Request)() {
  SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
  if (!SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_type_support_handle.typesupport_identifier) {
    SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetGTOrigin_Request__rosidl_typesupport_introspection_c__SetGTOrigin_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_fini_function(void * message_memory)
{
  mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_member_array[2] = {
  {
    "success",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_members = {
  "mocap4r2_robot_gt_msgs__srv",  // message namespace
  "SetGTOrigin_Response",  // message name
  2,  // number of fields
  sizeof(mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response),
  SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_member_array,  // message members
  SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_type_support_handle = {
  0,
  &SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap4r2_robot_gt_msgs, srv, SetGTOrigin_Response)() {
  if (!SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_type_support_handle.typesupport_identifier) {
    SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetGTOrigin_Response__rosidl_typesupport_introspection_c__SetGTOrigin_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
