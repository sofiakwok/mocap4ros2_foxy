  ...
  mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request * data =
      (mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response * data =
      (mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_robot_gt_msgs__srv__SetGTOrigin_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
