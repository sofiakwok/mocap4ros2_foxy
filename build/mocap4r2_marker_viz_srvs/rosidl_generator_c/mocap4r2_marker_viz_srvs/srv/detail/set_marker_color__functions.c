...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__init(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request * msg)
{
  ...
  if (!std_msgs__msg__Int32__init(&msg->id)) {
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__fini(msg);
    return false;
  }
  // color
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__create()
{
  ...
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request * msg = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request *)allocator.allocate(sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request));
  bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__init(msg);
  if (!success) {
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__init(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request * data = NULL;

  if (size) {
    data = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request *)allocator.zero_allocate(size, sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__fini(&data[i - 1]);
      }
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__fini(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * array = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence *)allocator.allocate(sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__init(array, size);
  if (!success) {
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__destroy(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence__are_equal(const mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * lhs, const mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request);
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request * data =
      (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response * msg = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response *)allocator.allocate(sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response));
  bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__destroy(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__init(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response * data = NULL;

  if (size) {
    data = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response *)allocator.zero_allocate(size, sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__fini(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * array = (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence *)allocator.allocate(sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__destroy(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence__are_equal(const mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * lhs, const mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response);
    mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response * data =
      (mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mocap4r2_marker_viz_srvs__srv__SetMarkerColor_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
