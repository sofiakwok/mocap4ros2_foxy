...
{
  return max_serialized_size_mocap4r2_marker_viz_srvs__srv__ResetMarkerColor_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_mocap4r2_marker_viz_srvs__srv__ResetMarkerColor_Response(
    full_bounded, 0);
}
