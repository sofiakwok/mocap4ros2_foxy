...
static size_t _ResetMarkerColor_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ResetMarkerColor_Request(full_bounded, 0);
}
...
static size_t _ResetMarkerColor_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ResetMarkerColor_Response(full_bounded, 0);
}
...
static rosidl_service_type_support_t _ResetMarkerColor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
