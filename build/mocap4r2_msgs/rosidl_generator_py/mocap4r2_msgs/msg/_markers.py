...
class Metaclass_Markers(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mocap4r2_msgs.msg import Marker
...
class Markers(metaclass=Metaclass_Markers):
    ...
    _fields_and_field_types = {
        ...
        'frame_number': 'uint32',
        'markers': 'sequence<mocap4r2_msgs/Marker>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mocap4r2_msgs', 'msg'], 'Marker')),  # noqa: E501
    )
