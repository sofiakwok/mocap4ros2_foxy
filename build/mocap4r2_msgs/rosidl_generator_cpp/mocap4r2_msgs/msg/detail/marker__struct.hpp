...
#ifndef MOCAP4R2_MSGS__MSG__DETAIL__MARKER__STRUCT_HPP_
#define MOCAP4R2_MSGS__MSG__DETAIL__MARKER__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__mocap4r2_msgs__msg__Marker __attribute__((deprecated))
#else
# define DEPRECATED__mocap4r2_msgs__msg__Marker __declspec(deprecated)
#endif
...
struct Marker_
{
  ...
  // pointer types
  using RawPtr =
    mocap4r2_msgs::msg::Marker_<ContainerAllocator> *;
  using ConstRawPtr =
    const mocap4r2_msgs::msg::Marker_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      mocap4r2_msgs::msg::Marker_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__mocap4r2_msgs__msg__Marker
    std::shared_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__mocap4r2_msgs__msg__Marker
    std::shared_ptr<mocap4r2_msgs::msg::Marker_<ContainerAllocator> const>
...
using Marker =
  mocap4r2_msgs::msg::Marker_<std::allocator<void>>;
...
#endif  // MOCAP4R2_MSGS__MSG__DETAIL__MARKER__STRUCT_HPP_
