...
#include "mocap4r2_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _RigidBodies_type_support_symbol_names_t _RigidBodies_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap4r2_msgs, msg, RigidBodies)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap4r2_msgs, msg, RigidBodies)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_mocap4r2_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mocap4r2_msgs, msg, RigidBodies)() {
  return &::mocap4r2_msgs::msg::rosidl_typesupport_c::RigidBodies_message_type_support_handle;
}
