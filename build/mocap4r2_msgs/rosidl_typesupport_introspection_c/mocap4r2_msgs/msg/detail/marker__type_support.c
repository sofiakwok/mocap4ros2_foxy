  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mocap4r2_msgs__msg__Marker__init(message_memory);
}

void Marker__rosidl_typesupport_introspection_c__Marker_fini_function(void * message_memory)
{
  mocap4r2_msgs__msg__Marker__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Marker__rosidl_typesupport_introspection_c__Marker_message_member_array[4] = {
  {
    ...
    offsetof(mocap4r2_msgs__msg__Marker, id_type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs__msg__Marker, marker_index),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs__msg__Marker, marker_name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs__msg__Marker, translation),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Marker__rosidl_typesupport_introspection_c__Marker_message_members = {
  ...
  "Marker",  // message name
  4,  // number of fields
  sizeof(mocap4r2_msgs__msg__Marker),
