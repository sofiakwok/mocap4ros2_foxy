...
mocap4r2_msgs__msg__ImusInfo__init(mocap4r2_msgs__msg__ImusInfo * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->sensor_ids, 0)) {
    mocap4r2_msgs__msg__ImusInfo__fini(msg);
    return false;
  }
  // battery_level
  // temperature
...
mocap4r2_msgs__msg__ImusInfo__create()
{
  ...
  mocap4r2_msgs__msg__ImusInfo * msg = (mocap4r2_msgs__msg__ImusInfo *)allocator.allocate(sizeof(mocap4r2_msgs__msg__ImusInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mocap4r2_msgs__msg__ImusInfo));
  bool success = mocap4r2_msgs__msg__ImusInfo__init(msg);
  if (!success) {
...
mocap4r2_msgs__msg__ImusInfo__Sequence__init(mocap4r2_msgs__msg__ImusInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__ImusInfo * data = NULL;

  if (size) {
    data = (mocap4r2_msgs__msg__ImusInfo *)allocator.zero_allocate(size, sizeof(mocap4r2_msgs__msg__ImusInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mocap4r2_msgs__msg__ImusInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mocap4r2_msgs__msg__ImusInfo__fini(&data[i - 1]);
      }
...
mocap4r2_msgs__msg__ImusInfo__Sequence__fini(mocap4r2_msgs__msg__ImusInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mocap4r2_msgs__msg__ImusInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__ImusInfo__Sequence * array = (mocap4r2_msgs__msg__ImusInfo__Sequence *)allocator.allocate(sizeof(mocap4r2_msgs__msg__ImusInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mocap4r2_msgs__msg__ImusInfo__Sequence__init(array, size);
  if (!success) {
...
mocap4r2_msgs__msg__ImusInfo__Sequence__destroy(mocap4r2_msgs__msg__ImusInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mocap4r2_msgs__msg__ImusInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mocap4r2_msgs__msg__ImusInfo__Sequence__are_equal(const mocap4r2_msgs__msg__ImusInfo__Sequence * lhs, const mocap4r2_msgs__msg__ImusInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mocap4r2_msgs__msg__ImusInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mocap4r2_msgs__msg__ImusInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mocap4r2_msgs__msg__ImusInfo);
    mocap4r2_msgs__msg__ImusInfo * data =
      (mocap4r2_msgs__msg__ImusInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__msg__ImusInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__msg__ImusInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mocap4r2_msgs__msg__ImusInfo__copy(
