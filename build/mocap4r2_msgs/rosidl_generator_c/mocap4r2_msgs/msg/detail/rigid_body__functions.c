...
mocap4r2_msgs__msg__RigidBody__init(mocap4r2_msgs__msg__RigidBody * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->rigid_body_name)) {
    mocap4r2_msgs__msg__RigidBody__fini(msg);
    return false;
  }
  // markers
  if (!mocap4r2_msgs__msg__Marker__Sequence__init(&msg->markers, 0)) {
    mocap4r2_msgs__msg__RigidBody__fini(msg);
    return false;
  }
  // pose
...
mocap4r2_msgs__msg__RigidBody__fini(mocap4r2_msgs__msg__RigidBody * msg)
{
  ...
  // markers
  mocap4r2_msgs__msg__Marker__Sequence__fini(&msg->markers);
  // pose
...
mocap4r2_msgs__msg__RigidBody__are_equal(const mocap4r2_msgs__msg__RigidBody * lhs, const mocap4r2_msgs__msg__RigidBody * rhs)
{
  ...
  // markers
  if (!mocap4r2_msgs__msg__Marker__Sequence__are_equal(
  ...
  mocap4r2_msgs__msg__RigidBody * output)
{
  ...
  // markers
  if (!mocap4r2_msgs__msg__Marker__Sequence__copy(
...
mocap4r2_msgs__msg__RigidBody__create()
{
  ...
  mocap4r2_msgs__msg__RigidBody * msg = (mocap4r2_msgs__msg__RigidBody *)allocator.allocate(sizeof(mocap4r2_msgs__msg__RigidBody), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mocap4r2_msgs__msg__RigidBody));
  bool success = mocap4r2_msgs__msg__RigidBody__init(msg);
  if (!success) {
...
mocap4r2_msgs__msg__RigidBody__Sequence__init(mocap4r2_msgs__msg__RigidBody__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__RigidBody * data = NULL;

  if (size) {
    data = (mocap4r2_msgs__msg__RigidBody *)allocator.zero_allocate(size, sizeof(mocap4r2_msgs__msg__RigidBody), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mocap4r2_msgs__msg__RigidBody__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mocap4r2_msgs__msg__RigidBody__fini(&data[i - 1]);
      }
...
mocap4r2_msgs__msg__RigidBody__Sequence__fini(mocap4r2_msgs__msg__RigidBody__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mocap4r2_msgs__msg__RigidBody__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__RigidBody__Sequence * array = (mocap4r2_msgs__msg__RigidBody__Sequence *)allocator.allocate(sizeof(mocap4r2_msgs__msg__RigidBody__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mocap4r2_msgs__msg__RigidBody__Sequence__init(array, size);
  if (!success) {
...
mocap4r2_msgs__msg__RigidBody__Sequence__destroy(mocap4r2_msgs__msg__RigidBody__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mocap4r2_msgs__msg__RigidBody__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mocap4r2_msgs__msg__RigidBody__Sequence__are_equal(const mocap4r2_msgs__msg__RigidBody__Sequence * lhs, const mocap4r2_msgs__msg__RigidBody__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mocap4r2_msgs__msg__RigidBody__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mocap4r2_msgs__msg__RigidBody__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mocap4r2_msgs__msg__RigidBody);
    mocap4r2_msgs__msg__RigidBody * data =
      (mocap4r2_msgs__msg__RigidBody *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__msg__RigidBody__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__msg__RigidBody__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mocap4r2_msgs__msg__RigidBody__copy(
