...
mocap4r2_msgs__msg__Markers__init(mocap4r2_msgs__msg__Markers * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    mocap4r2_msgs__msg__Markers__fini(msg);
    return false;
  }
  // frame_number
  // markers
...
mocap4r2_msgs__msg__Markers__create()
{
  ...
  mocap4r2_msgs__msg__Markers * msg = (mocap4r2_msgs__msg__Markers *)allocator.allocate(sizeof(mocap4r2_msgs__msg__Markers), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mocap4r2_msgs__msg__Markers));
  bool success = mocap4r2_msgs__msg__Markers__init(msg);
  if (!success) {
...
mocap4r2_msgs__msg__Markers__Sequence__init(mocap4r2_msgs__msg__Markers__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__Markers * data = NULL;

  if (size) {
    data = (mocap4r2_msgs__msg__Markers *)allocator.zero_allocate(size, sizeof(mocap4r2_msgs__msg__Markers), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mocap4r2_msgs__msg__Markers__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mocap4r2_msgs__msg__Markers__fini(&data[i - 1]);
      }
...
mocap4r2_msgs__msg__Markers__Sequence__fini(mocap4r2_msgs__msg__Markers__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mocap4r2_msgs__msg__Markers__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mocap4r2_msgs__msg__Markers__Sequence * array = (mocap4r2_msgs__msg__Markers__Sequence *)allocator.allocate(sizeof(mocap4r2_msgs__msg__Markers__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mocap4r2_msgs__msg__Markers__Sequence__init(array, size);
  if (!success) {
...
mocap4r2_msgs__msg__Markers__Sequence__destroy(mocap4r2_msgs__msg__Markers__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mocap4r2_msgs__msg__Markers__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mocap4r2_msgs__msg__Markers__Sequence__are_equal(const mocap4r2_msgs__msg__Markers__Sequence * lhs, const mocap4r2_msgs__msg__Markers__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mocap4r2_msgs__msg__Markers__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mocap4r2_msgs__msg__Markers__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mocap4r2_msgs__msg__Markers);
    mocap4r2_msgs__msg__Markers * data =
      (mocap4r2_msgs__msg__Markers *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__msg__Markers__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__msg__Markers__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mocap4r2_msgs__msg__Markers__copy(
