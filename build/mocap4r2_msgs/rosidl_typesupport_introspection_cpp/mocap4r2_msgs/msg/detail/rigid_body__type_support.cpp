...
{
  new (message_memory) mocap4r2_msgs::msg::RigidBody(_init);
}

void RigidBody_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mocap4r2_msgs::msg::RigidBody *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RigidBody_message_member_array[3] = {
  {
    ...
    offsetof(mocap4r2_msgs::msg::RigidBody, rigid_body_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs::msg::RigidBody, markers),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs::msg::RigidBody, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RigidBody_message_members = {
  ...
  3,  // number of fields
  sizeof(mocap4r2_msgs::msg::RigidBody),
...
{
  return &::mocap4r2_msgs::msg::rosidl_typesupport_introspection_cpp::RigidBody_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap4r2_msgs, msg, RigidBody)() {
  return &::mocap4r2_msgs::msg::rosidl_typesupport_introspection_cpp::RigidBody_message_type_support_handle;
}
