...
{
  new (message_memory) mocap4r2_msgs::msg::RigidBodies(_init);
}

void RigidBodies_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mocap4r2_msgs::msg::RigidBodies *>(message_memory);
  typed_message->~RigidBodies();
}

size_t size_function__RigidBodies__rigidbodies(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<mocap4r2_msgs::msg::RigidBody> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<mocap4r2_msgs::msg::RigidBody> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<mocap4r2_msgs::msg::RigidBody> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RigidBodies_message_member_array[3] = {
  {
    ...
    offsetof(mocap4r2_msgs::msg::RigidBodies, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs::msg::RigidBodies, frame_number),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<mocap4r2_msgs::msg::RigidBody>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(mocap4r2_msgs::msg::RigidBodies, rigidbodies),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RigidBodies_message_members = {
  ...
  3,  // number of fields
  sizeof(mocap4r2_msgs::msg::RigidBodies),
...
{
  return &::mocap4r2_msgs::msg::rosidl_typesupport_introspection_cpp::RigidBodies_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap4r2_msgs, msg, RigidBodies)() {
  return &::mocap4r2_msgs::msg::rosidl_typesupport_introspection_cpp::RigidBodies_message_type_support_handle;
}
